...
void setPropertyCircleHitbox(
    CircleHitbox classReference, String propertyName, dynamic value) {
  switch (propertyName) {
    case 'position':
      classReference.position = value as Vector2;
      break;
...
void setPropertyPolygonHitbox(
    PolygonHitbox classReference, String propertyName, dynamic value) {
  switch (propertyName) {
    case 'position':
      classReference.position = value as Vector2;
      break;
...
void setPropertyRectangleComponent(
    RectangleComponent classReference, String propertyName, dynamic value) {
  switch (propertyName) {
    case 'position':
      classReference.position = value as Vector2;
      break;
